/*
Whereas the regular timeline shows minutes and seconds, this timeline
...
module.exports = function(){
    ...
    function updateMinorLines(x){
        ...
        var ticks = d3.range(0, 3, 0.25)
            .concat(d3.range(3, 4, 1/6))
            .concat(d3.range(4, 6, 1/3));

        // minor lines disapped in d3 version 3, so have to be done explicitly
        var minorLines = selection.selectAll('line.minor').data(ticks, function(d) { return d; })
    ...
    function timeline(_selection){
        ...
        // x is now musical time to pixels
