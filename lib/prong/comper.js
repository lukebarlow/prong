...
module.exports = function(){
    ...
    var editList = [{'track' : 0, start : 0}],
        ...
        timeline, // the timeline component this comper listens to for resize events
    ...
    comper.timeline = function(_timeline){
    ...
    return d3.rebind(comper, commonProperties(), 'x');
}